  ...
  return (
    <section id="about">
      <div className="flex px-10 py-20 md:flex-column flex-column bg-gray-100">
        ...
        <div className="px-10 py-20 md:flex-row flex-row items-center">
          <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2 px-20 py-20">
            ...
            also honing my product management skills.
            </p>
          </div>
        </div>
      </div>
